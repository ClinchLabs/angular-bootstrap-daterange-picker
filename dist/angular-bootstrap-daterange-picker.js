...
var DateRange = function () {
	function DateRange(startDate, endDate, locale) {
		...
		this._endDate = endDate ? (0, _moment2.default)(endDate) : null;
		this._locale = locale;
	}
  ...
  */
	...
	_createClass(DateRange, [{
		...
		value: function isValid(startDate, endDate) {
			...
			var start = _moment2.default.isMoment(startDate) ? startDate : (0, _moment2.default)(startDate);
			var end = _moment2.default.isMoment(endDate) ? endDate : (0, _moment2.default)(endDate);
    ...
    function link(scope, ele, attr, modelCtrl) {
        ...
        if (attr.dateMin) {
            modelCtrl.$validators.dateMin = function (value) {
                return value && _dateRange2.default.isValid(opts['minDate'], value.startDate);
            };
            scope.$watch('dateMin', function (date) {
                opts['minDate'] = date ? (0, _moment2.default)(date) : false;
                _init();
            });
        }
        if (attr.dateMax) {
            modelCtrl.$validators.dateMax = function (value) {
                return value && _dateRange2.default.isValid(value.endDate, opts['maxDate']);
            };
            scope.$watch('dateMax', function (date) {
                opts['maxDate'] = date ? (0, _moment2.default)(date) : false;
                _init();
            });
        }
        ...
        modelCtrl.$parsers.push(function (value) {
            if (value instanceof _dateRange2.default) return value;
            ...
            return new _dateRange2.default(start, end, opts.locale);
        });
        ...
        modelCtrl.$formatters.push(function (model) {
            return model instanceof _dateRange2.default ? model.toString() : new _dateRange2.default(model.startDate, model.endDate, opts.locale).toString();
        });
        ...
        function _init() {
            ...
            if (attr.hasOwnProperty('dateClearable')) {
                ...
                el.on('cancel.daterangepicker', function () {
                    scope.$apply(scope.model = new _dateRange2.default(null, null, opts.locale));
                });
            }
